...
import com.sec.ilearn.pojo.RemoteConnect;
import org.apache.logging.log4j.LogManager;
import org.apache.logging.log4j.Logger;

import java.io.*;

public class RemoteToLinux {

    private static final Logger logger = LogManager.getLogger(RemoteToLinux.class);
    ...
    public static String connectLinux(String ip,String userName,String password,String commandStr) {
        ...
        try {
            if (login(remoteConnect)) {
                returnStr = executeCmd(commandStr);
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
